...
class Server {
     ...
     *  - **dbAdapter** The database adapter class
     *  - **dbConfig** The database config to pass to the adapter instance
     *  - **debugFn** A function to use to output debug info (optional)
     *  - **fileAdapter** The adapter the server will use to work with files
     *  - **fileConfig** The config object that will be passed to the file adapter
     *  - **keyAdapter** The adapter the server will use to work with ssh keys
     *  - **keyConfig** The config object that will be passed to the key adapter
    ...
    /**
     * Cleanup after the server is quitting.
     */
    destroy() {
